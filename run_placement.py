#!/usr/bin/env python3
"""
Convenient runner for the stratified placement system

This is the main entry point users should use to run placements.
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Stratified Placement System Runner",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  python3 run_placement.py                               # Basic placement (auto-generates CSV + plot)
  python3 run_placement.py --detailed                    # With quality analysis + CSV + plot
  python3 run_placement.py --visualize                   # Full interactive analysis + CSV + plot
  python3 run_placement.py --output-name "room_v1"       # Custom filenames (room_v1.csv + room_v1_plot.png)
  python3 run_placement.py --trials 10                   # Multiple random trials (each with CSV + plot)
  python3 run_placement.py --config custom.yaml          # Custom config file
        """
    )
